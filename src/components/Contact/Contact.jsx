...
const Contact = () => {
  return (
    <section className="h-[344px] font-manrope px-6 md:pl-[100px] pb-2 pt-4 mt-6 text-white bg-titleColor  sm:px-20 lg:flex lg:p-0 lg:mt-20 lg:h-[300px] xl:justify-between 2xl:h-[400px] 2xl:items-center">
